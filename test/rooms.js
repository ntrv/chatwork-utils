...
describe('/roomsのテスト', () => {
  ...
  it('GET /rooms/{{roomId}}/messages/{{messageId}}', () => {
    const cw = new Chatwork('apiKey');
    const mock = new MockAdapter(cw.instance);
  ...
  it('GET /rooms/{{roomId}}/tasks/{{taskId}}', () => {
    const cw = new Chatwork('apiKey');
    const mock = new MockAdapter(cw.instance);
  ...
  it('GET /rooms/{{roomId}}/files/{{fileId}}', () => {
    const cw = new Chatwork('apiKey');
    const mock = new MockAdapter(cw.instance);
